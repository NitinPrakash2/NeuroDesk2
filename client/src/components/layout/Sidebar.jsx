...
const menuItems = [
  { name: 'Home',      icon: LayoutDashboard, color: 'text-violet-500', bg: 'bg-violet-50',  activeBg: 'bg-violet-100' },
  { name: 'Tasks',     icon: ListTodo,        color: 'text-blue-500',   bg: 'bg-blue-50',    activeBg: 'bg-blue-100'   },
  { name: 'Notes',     icon: NotebookPen,     color: 'text-orange-500', bg: 'bg-orange-50',  activeBg: 'bg-orange-100' },
  { name: 'Files',     icon: FolderOpen,      color: 'text-yellow-500', bg: 'bg-yellow-50',  activeBg: 'bg-yellow-100' },
  { name: 'Memory',    icon: BrainCircuit,    color: 'text-red-500',    bg: 'bg-red-50',     activeBg: 'bg-red-100'    },
  { name: 'Goals',     icon: Trophy,          color: 'text-teal-500',   bg: 'bg-teal-50',    activeBg: 'bg-teal-100'   },
  { name: 'Analytics', icon: BarChart3,       color: 'text-pink-500',   bg: 'bg-pink-50',    activeBg: 'bg-pink-100'   },
];
