...
export default function Goal() {
  ...
  const [chatOpen, setChatOpen] = useState(null); // goalId of open chat
  const [chatMessages, setChatMessages] = useState({}); // { goalId: [{role, text}] }
        ...
        <div className="max-w-[900px] mx-auto pb-16">
          ...
          <div className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-slate-500 text-sm font-medium mt-1">Set long-term goals and let AI build your roadmap</p>
            </div>
            <button
              onClick={openModal}
          ...
          {!loading && goals.length > 0 && (
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                ...
                <div key={s.label} className={`${s.color} rounded-[16px] p-4 flex items-center gap-3`}>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {goals.map(goal => {
                ...
                return (
                  <div key={goal.id} className="bg-white rounded-[20px] border border-slate-100 shadow-sm hover:shadow-md transition-all duration-200">
                    <div className="p-6">
