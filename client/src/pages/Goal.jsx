    ...
    <>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between gap-4 mb-2">
              ...
              <button onClick={openModal} className="flex items-center gap-2 px-4 py-2.5 bg-[#5A67D8] text-white rounded-xl text-xs font-bold hover:bg-indigo-600 transition-all shadow-sm hover:shadow-md flex-shrink-0">
