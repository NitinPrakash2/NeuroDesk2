  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
            {/* Card 1: Daily Focus */}
            <div className="bg-white p-4 md:p-5 rounded-[20px] shadow-sm border border-slate-100 flex flex-col justify-between min-h-[130px] md:h-36 hover:shadow-xl hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="flex items-center gap-2 md:gap-3 min-w-0">
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 flex-shrink-0">
                  <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" /><path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" /></svg>
                </div>
                <div className="min-w-0">
                  <h3 className="font-bold text-xs md:text-sm text-slate-800 truncate">Daily Focus</h3>
                  <p className="text-[10px] md:text-xs text-slate-500 font-medium mt-0.5 flex items-center gap-1 truncate">Complete Report <svg className="w-3 h-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg></p>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-[10px] md:text-[11px] text-slate-400 font-bold mb-1.5 md:mb-2 px-1">
            ...
            <div className="bg-white p-4 md:p-5 rounded-[20px] shadow-sm border border-slate-100 min-h-[130px] md:h-36 overflow-hidden hover:shadow-xl hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-500 flex-shrink-0">
                ...
                <h3 className="font-bold text-xs md:text-sm text-slate-800 truncate">AI Suggestions</h3>
              </div>
              <ul className="text-[10px] md:text-[11px] text-slate-600 space-y-1 font-medium">
                {suggestions.slice(0, 3).map((suggestion, i) => (
                  <li key={i} className="flex items-start gap-1.5">
                    <div className="w-2.5 h-2.5 rounded bg-slate-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-1.5 h-1.5 text-slate-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                    </div>
                ...
                {suggestions.length === 0 && (
                  <li className="flex items-center gap-1.5">
                    <div className="w-2.5 h-2.5 rounded bg-slate-100 flex items-center justify-center flex-shrink-0">
                      <svg className="w-1.5 h-1.5 text-slate-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                    </div>
                    Loading suggestions...
                  </li>
            ...
            <div className="bg-white p-4 md:p-5 rounded-[20px] shadow-sm border border-slate-100 flex flex-col justify-between min-h-[130px] md:h-36 hover:shadow-xl hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="flex items-center gap-2 md:gap-3 min-w-0">
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-teal-50 flex items-center justify-center text-teal-600 flex-shrink-0">
                  <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>
                </div>
                <div className="min-w-0">
                  <h3 className="font-bold text-xs md:text-sm text-slate-800 truncate">Personal Goals</h3>
                  <p className="text-[10px] md:text-[11px] text-slate-500 font-medium mt-0.5 flex items-center gap-1 truncate"><svg className="w-2.5 h-2.5 md:w-3 md:h-3 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 5l7 7-7 7M5 5l7 7-7 7" /></svg> {goals[0]?.title || 'No goals yet'}</p>
                </div>
              </div>
              <div className="flex items-center justify-between mt-2 md:mt-4 gap-1">
                <span className="px-2 md:px-3 py-1 bg-teal-50 text-teal-600 rounded text-[9px] md:text-[10px] font-bold flex-shrink-0">{goals[0]?.status || 'On Track'}</span>
                <div className="flex-1 bg-slate-100 h-[3px] rounded-full min-w-0"><div className="bg-teal-400 h-[3px] rounded-full" style={{width: `${goals[0]?.progress || 0}%`}}></div></div>
                <span className="text-[10px] md:text-xs font-bold text-slate-700 flex-shrink-0">{goals[0]?.progress || 0}%</span>
              </div>
            </div>

            {/* Card 4: Memory Vault */}
            <div className="bg-white p-4 md:p-5 rounded-[20px] shadow-sm border border-slate-100 min-h-[130px] md:h-36 flex flex-col justify-between hover:shadow-xl hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <h3 className="font-bold text-xs md:text-sm text-slate-800 truncate">Memory Vault</h3>
              </div>
              <div className="p-2 md:p-3 bg-slate-50 rounded-xl border border-slate-100 flex gap-2 md:gap-3 items-center min-w-0">
                <div className="w-7 h-7 md:w-8 md:h-8 bg-white rounded-lg shadow-sm flex items-center justify-center border border-slate-100 flex-shrink-0">
                  <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                </div>
                <div className="min-w-0">
                  <p className="text-[11px] md:text-xs font-bold text-slate-800 truncate">{memories[0]?.label || 'No memories'}</p>
                  <p className="text-[9px] md:text-[10px] text-slate-500 font-medium truncate">{memories[0]?.type === 'password' ? '••••••••' : memories[0]?.value || 'Store your first memory'}</p>
                </div>
              </div>
            </div>
          </div>
